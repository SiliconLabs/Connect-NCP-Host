 ...
 *
 */
EmberStatus emberSetNcpSecurityKeyPersistent(uint8_t *keyContents, uint8_t keyLength, psa_key_id_t key_id);
 ...
 *
 */
EmberStatus emberSetNcpSecurityKey(uint8_t *keyContents, uint8_t keyLength);
